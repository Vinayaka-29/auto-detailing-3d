...
import VDashboard from './pages/Dashboard'
import VServices  from './pages/Services'
import VBookings  from './pages/Bookings'
import VAnalytics from './pages/Analytics'
import VProfile   from './pages/VendorProfile'
      ...
      <aside className="w-56 bg-surface border-r border-white/8 flex flex-col flex-shrink-0">
        <div className="p-5 border-b border-white/8">
          <div className="flex items-center gap-2">
            ...
            <div>
              <p className="font-display font-bold text-white text-sm">Vendor Hub</p>
...
function AppRoutes() {
  return (
    <Routes>
      ...
      <Route path="/dashboard" element={<PrivateRoute><Shell><VDashboard /></Shell></PrivateRoute>} />
      <Route path="/bookings"  element={<PrivateRoute><Shell><VBookings /></Shell></PrivateRoute>} />
      <Route path="/services"  element={<PrivateRoute><Shell><VServices /></Shell></PrivateRoute>} />
      <Route path="/analytics" element={<PrivateRoute><Shell><VAnalytics /></Shell></PrivateRoute>} />
      <Route path="/profile"   element={<PrivateRoute><Shell><VProfile /></Shell></PrivateRoute>} />
